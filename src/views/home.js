    ...
    <div className="home-container">
      ...
      <section className="home-hero">
        <div className="home-heading">
          <h1 className="home-header01">Create yourself for the metaverse</h1>
          ...
          <div className="home-card">
            ...
            <div className="home-main">
              <div className="home-content01">
                <h2 className="home-header02">10,000+ unique characters</h2>
      ...
      <section className="home-collection">
        <div className="home-content04">
          ...
          <div className="home-heading01">
            <h2 className="home-header05">All time best collections</h2>
        ...
        <div className="home-understand">
          <div className="home-content13">
            ...
            <div className="home-heading02">
              <h2 className="home-header07">Understand the project</h2>
        ...
        <div className="home-mining">
          ...
          <div className="home-content14">
            ...
            <div className="home-heading03">
              <h2 className="home-header09">How the minting works</h2>
      ...
      <section className="home-roadmap">
        <div className="home-heading04">
          <h2 className="home-header11">Roadmap</h2>
        ...
        <div className="home-list">
          <div className="home-step">
            ...
            <div className="home-heading05">
              <h2 className="home-header13">Project Launch</h2>
          ...
          <div className="home-step1">
            ...
            <div className="home-heading06">
              <h2 className="home-header15">Metadata and Character</h2>
          ...
          <div className="home-step2">
            ...
            <div className="home-heading07">
              <h2 className="home-header17">Get Physical</h2>
          ...
          <div className="home-step3">
            ...
            <div className="home-heading08">
              <h2 className="home-header19">Private club community</h2>
        ...
        <div className="home-content15">
          <div className="home-main4">
            <div className="home-heading09">
              <h2 className="home-header24">Create your character now</h2>
      ...
      <section className="home-faq">
        <h2 className="home-header25">We have all the answers</h2>
        ...
        <div className="home-column2">
          <div className="home-card13">
            <div className="home-content21">
              <h2 className="home-header31">Get yours now</h2>
